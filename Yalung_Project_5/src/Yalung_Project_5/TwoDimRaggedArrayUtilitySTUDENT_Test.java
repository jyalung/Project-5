...
public class TwoDimRaggedArrayUtilitySTUDENT_Test {
	...
	private double[][] dataSetSTUDENT = {{1,2,3} , {3,5} , {8,8,9,0} };
	...
	public void testGetTotal() {
		assertEquals(39.0,TwoDimRaggedArrayUtility.getTotal(dataSetSTUDENT),.001);
	}
	...
	public void testGetAverage() {
		assertEquals(4.3333,TwoDimRaggedArrayUtility.getAverage(dataSetSTUDENT),.001);
	}
	...
	public void testGetRowTotal() {
		assertEquals(6.0,TwoDimRaggedArrayUtility.getRowTotal(dataSetSTUDENT,0),.001);	
	}
	...
	public void testGetColumnTotal() {
		assertEquals(15.0,TwoDimRaggedArrayUtility.getColumnTotal(dataSetSTUDENT,1),.001);
	}
